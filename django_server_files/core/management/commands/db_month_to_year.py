...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        logger.info("Aggregating monthly data into daily averages for yearly storage...")
        ...
        logger.info("Deleting old records from HistoryMonth...")
        HistoryMonth.objects.filter(timestamp__lt=one_month_ago).delete()
        logger.info("Successfully aggregated daily data into yearly records and cleaned up old records.")
